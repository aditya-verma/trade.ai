...
class Created(TradeAIBaseResponse):
    """201 Created
...
class BadRequest(TradeAIBaseResponse):
    """400 Bad Request
...
class Forbidden(TradeAIBaseResponse):
    """403 Forbidden
...
class NotFound(TradeAIBaseResponse):
    """404 Not Found
...
class InternalServerError(TradeAIBaseResponse):
...
class NotImplemented(TradeAIBaseResponse):
    """501 Not Implemented
